...
console.log('🔧 Fixing audit trigger...\n');
...
const req = https.request(queryUrl, options, (res) => {
  ...
  res.on('end', () => {
    if (res.statusCode === 200 || res.statusCode === 201 || res.statusCode === 204) {
      ...
      console.error(`❌ Fix failed with status ${res.statusCode}:`, data);
      console.log('\n⚠️  Trying alternative approach via query endpoint...\n');
      process.exit(1);
    }
  });
});
